...
def decrypt():
    ...
    if password == '1234':
        ...
        try:
            ...
            decrypted = decode_message.decode('ascii')
            ...
            messagebox.showerror("Decryption Error", "Invalid Base64 message")
    elif password == "":
...
def main_screen():
    ...
    # Icon
    image_icon = PhotoImage(file='key.png')  # Ensure the image file exists
